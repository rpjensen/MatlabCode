%% function [refAngle,theSign] = findSinDomain(oldAngle)
%
% Maps an angle to the functional domain, [0,pi/2], for evaluating sine
% Input:
%    oldAngle
%    The angle at which you are evaluating the sine function.
% Outputs:
%    refAngle
%    This is the reference angle in [0,pi/2] for which
%      |sin(oldAngle)| = |sin(refAngle)|
%    theSign
%    Returns the value 1 or -1 if sin(oldAngle) is pos or neg, respectively.
function [refAngle,theSign] = findSinDomain(oldAngle)
